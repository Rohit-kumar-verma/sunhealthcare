    ...
    <div className="bg-gray-50 py-6">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full">
          ...
          >
            <motion.h3
              className="text-3xl font-semibold mb-8 text-[#00ADB5] sm:text-3xl xs:text-xl"
            ...
            <motion.ul
              className="list-disc pl-2 text-[#8C96A7] text-sm md:text-xl flex flex-col gap-8 sm:text-base sm:gap-4"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: isInView ? 1 : 0, x: isInView ? 0 : -20 }}
              transition={{ duration: 1.5, ease: 'easeOut' }}
            >
              <li className="font-bold text-lg list-none flex items-center sm:text-base xs:text-sm">
                <Image src="/telephone-call.png" width={20} height={20} alt="" className="mr-1" />
                Call Us:
                <ul className="ml-2">
                  <li className="text-[#8C96A7] text-xl sm:text-base xs:text-sm">
              ...
              <li className="text-[#8C96A7] md:text-lg flex items-center text-sm ">
                <Image src="/social.png" alt="" width={20} height={20} className="mr-1" />
                <h5 className="md:text-lg mr-2 text-sm">Email:</h5>
                <a
                  href="mailto:sunhomehealthcare820@gmail.com"
                  className="text-[#00ADB5] hover:underline font-bold"
                >sunhomehealthcare<br className='block md:hidden'/>820@gmail.com
                </a>
              </li>
              <li className="text-[#8C96A7] text-sm flex items-center md:text-lg">
                <Image src="/instagram.png" alt="" width={20} height={20} className="mr-1" />
                <h5 className="md:text-lg mr-1 text-sm">Instagram: </h5>
                <a
              ...
              <li className="text-[#8C96A7] md:text-lg flex items-start xs:text-sm">
                <Image src="/location.png" alt="" width={20} height={20} className="mr-1 items-center" />
                <h5 className="text-lg mr-4 flex sm:text-base xs:text-sm">Address: </h5>
