...
function Footer() {
  return (
    <footer className='bg-cover mt-20 px-6 sm:px-10 py-8' style={{ backgroundImage: `url(${"footer-bg.jpg"})`}}>
      <div className='grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 p-6'>
        <div className='space-y-4'>
          <a href='#'>
            <img src='output-onlinegiftools.gif' alt='logo' className='w-46 sm:w-42 md:w-50 lg:w-44' />
          </a>
