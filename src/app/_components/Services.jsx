  ...
  return (
    <section id="service" className='p-6 pt-20'>
      ...
      <div className='grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-4 mt-8 '>
        <div className={`m-4 p-10 rounded-xl shadow-2xl shadow-[#00ADB5] hover:bg-[#00ADB5] hover:text-white transition duration-700 ease-in-out hover:z-10`}>
            <div>
                {/* <svg xmlns="http://www.w3.org/2000/svg" width="79.557" height="57.882" viewBox="0 0 79.557 57.882" className='fill-current text-[#00ADB5] group-hover:text-white'>
        ...
        <div className='m-4 p-10 rounded-xl shadow-2xl shadow-[#00ADB5] hover:bg-[#00ADB5] hover:text-white transition duration-700 ease-in-out'>
