  ...
  return (
    <section id="service" className='p-6 pt-20'>
      <div className='flex flex-col justify-center items-center px-4'>
        ...
        <p className='text-center text-[#8C96A7] text-base md:text-lg font-normal leading-6 px-4 md:px-20 lg:px-40 mt-6'>
        We provide our Services 24x7 as per your medical needs you can get our services via Contact us.
        </p>
      </div>

      <div className='grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-4 mt-8 '>
        <div className={`m-4 p-10 rounded-xl shadow-2xl shadow-[#00ADB5] group hover:bg-[#00ADB5] hover:text-white transition duration-700 ease-in-out hover:z-10`}>
            <div>
                <iframe src="https://lottie.host/embed/85c0c33b-d5c3-4885-a4f0-04b0ddc04604/jIXsgx2eQo.json"
                width={100}
                height={100}></iframe>
            </div>
          <div className='rounded-lg mt-4 hover:text-white'>
            <h4 className='text-2xl font-bold mb-4 group-hover:text-white'>Attendent</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>Personal Care Assistant, Mobility Support, Meal Assistant etc. you can get from here.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        </div>
        <div className='m-4 p-10 rounded-xl shadow-2xl shadow-[#00ADB5] group hover:bg-[#00ADB5] hover:text-white transition duration-700 ease-in-out'>
        <div className="service-icon mb-25">
            <Image src='/nurse.png' alt='' width={60} height={60}/>
			</div>
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>Nursing Care</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>Providing a cost-effective male or female attendant to care for a senior.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        ...
        <div className='m-4 p-10 rounded-xl shadow-2xl shadow-[#00ADB5] group hover:bg-[#00ADB5] hover:text-white transition duration-700 ease-in-out'>
          ...
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>Boby Care</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>we offer services for newborn care including monitoring the baby's growth and development, assisting with feeding and diaper changes, and keeping an eye out for any signs of illness or health concerns.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        ...
        <div className="service-icon mb-25">
          ...
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>Elder Care</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>We can offer you an attendant and affordable elder services to help you in your latter years.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        ...
        <div className="service-icon mb-25">
          ...
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>Physiothe<br className='md:block hidden'/>rapy</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>In an emergency, we can arrange for the best physiotherapist to visit you at home.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        ...
        <div className="service-icon mb-25">
          ...
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>ICU care</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>In an emergency, we provide ICU Care at your home in The Competitive Price Range.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
        ...
        <div className="service-icon mb-25">
          ...
          <div className='rounded-lg mt-4'>
            <h4 className='text-2xl font-bold mb-4'>Medical Equipments on rent</h4>
            <p className='mb-6 text-[#8C96A7] font-normal group-hover:text-white'>We offer medical equipment such as wheelchairs, oxygen concentrators, and hospital beds etc.</p>
            <a href='#' className='text-[#00ADB5] font-semibold flex items-center gap-2 group-hover:text-white'>Read more
                <MdArrowRightAlt className='text-2xl'/>
            </a>
          </div>
